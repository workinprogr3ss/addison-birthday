...
window.CONFIG = {
      ...
      ideas: [
        {
          ...
          text: "Sunrise hike to catch golden hour, and bring coffee in a thermos",
          effort: "high",
          budget: "free",
          season: "summer",
          details: {
        ...
        },
        {
          ...
          text: "Kayaking or paddleboarding, then pack sandwiches for a water picnic",
          effort: "medium",
          budget: "$$",
          season: "summer",
        },
        ...
        },
        {
          ...
          text: "Drive somewhere dark for stargazing, and bring blankets and hot cocoa",
          effort: "low",
          budget: "free",
          season: "any",
        },
    ...
    },
    {
      ...
      ideas: [
        ...
        },
        {
          ...
          text: "Farmers market morning, buy ingredients, then cook lunch together",
          effort: "low",
          budget: "$",
          season: "spring",
          details: {
        ...
        },
        {
          ...
          text: "Take a cooking class together, like pasta making or sushi rolling",
          effort: "medium",
          budget: "$$",
          season: "any",
        },
      ...
      ideas: [
        {
          ...
          text: "Paint night at home, same subject and different interpretations",
          effort: "low",
          budget: "$$",
          season: "any",
        },
  ...
  loveNotes: [
    ...
    },
    {
      ...
      message:
        '"In true love, the smallest distance is too great, and the greatest distance can be bridged." by Hans Nouwens. Miss you too. See you soon.',
    },
    {
    ...
    },
    {
      ...
      message:
        "You don't have to solve anything tonight. Put the phone down, take a slow breath, and let your brain clock out. We can deal with everything in the morning.",
    },
    {
    ...
    },
    {
      ...
      message:
        "\"Twenty years from now you'll be more disappointed by the things you didn't do.\" by Mark Twain. So what adventure are we doing next? Say the word.",
    },
    {
  ...
  bonusLoveNote: {
    ...
    message:
      "You did it. Every note opened, every reminder tucked away. Here is the bonus truth: loving you is the easiest thing I do.",
  },
