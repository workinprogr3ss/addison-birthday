...
window.CONFIG = {
    ...
    dateCategories: [
        ...
        },
        {
            ...
            ideas: [
                ...
                { id: "adventure-kayak-paddle", text: "Kayaking or paddleboarding, then pack sandwiches for a water picnic", effort: "medium", budget: "$$", season: "summer" },
                ...
                { id: "adventure-stargazing-drive", text: "Drive somewhere dark for stargazing, and bring blankets and hot cocoa", effort: "low", budget: "free", season: "any" }
            ]
        },
        {
            ...
            ideas: [
                ...
                { id: "foodie-cooking-class", text: "Take a cooking class together, like pasta making or sushi rolling", effort: "medium", budget: "$$", season: "any" },
        ...
        },
        {
            ...
            icon: "palette",
            ideas: [
                { id: "creative-paint-night", text: "Paint night at home, same subject and different interpretations", effort: "low", budget: "$$", season: "any" },
    ...
    loveNotes: [
        ...
        },
        {
            ...
            message: "\"In true love, the smallest distance is too great, and the greatest distance can be bridged.\" by Hans Nouwens. Miss you too. See you soon."
        },
        {
        ...
        },
        {
            ...
            message: "\"Twenty years from now you'll be more disappointed by the things you didn't do.\" by Mark Twain. So what adventure are we doing next? Say the word."
        },
        {
